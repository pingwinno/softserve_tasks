...
operation::item/shouldReturn200WhenCallPatchForUpdate[]

[[overview-put-item-failed]]
==== Failed

operation::item/shouldReturn404WhenCallPatchForUpdateWithNonExistingItem[snippets='http-response']
...
operation::registered_order/shouldReturn200WhenCallPatchForUpdate[]

[[overview-put-registered-order-failed]]
==== Failed

operation::registered_order/shouldReturn404WhenCallPatchForUpdateWithNonExistingOrder[snippets='http-response']
