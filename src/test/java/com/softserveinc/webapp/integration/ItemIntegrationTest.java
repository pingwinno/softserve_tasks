...
@SpringBootTest(properties = {"spring.datasource.url=jdbc:h2:mem:ItemIntegrationTest"
...
public class ItemIntegrationTest {
    ...
    public void shouldReturn200WhenCallPutForUpdate() throws Exception {
        this.mockMvc.perform(put("/item/{id}", itemWithID.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF8")
                .content(itemJsonWithID))
                .andDo(print())
    ...
    public void shouldReturn404WhenCallPutForUpdateWithNonExistingItem() throws Exception {
        this.mockMvc.perform(put("/item/{id}", UUID.randomUUID())
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF8")
                .content(itemJsonWithID))
                .andDo(print())
