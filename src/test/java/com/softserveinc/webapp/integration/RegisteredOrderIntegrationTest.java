...
@SpringBootTest(properties = {"spring.datasource.url=jdbc:h2:mem:RegisteredOrderIntegrationTest"
...
public class RegisteredOrderIntegrationTest {
    ...
    public void shouldReturn200WhenCallPutForUpdate() throws Exception {
        this.mockMvc.perform(put("/registered_order/{id}", orderWithID.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .characterEncoding("UTF8")
                .content(orderJsonWithID))
                .andDo(print())
    ...
    public void shouldReturn404WhenCallPutForUpdateWithNonExistingUser() throws Exception {
        this.mockMvc.perform(put("/registered_order/{id}", UUID.randomUUID())
                .contentType(MediaType.APPLICATION_JSON)
                .content(orderJsonWithID))
                .andDo(print())
